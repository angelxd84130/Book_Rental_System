...
$sqlcmd = "SELECT book.name,book.author,client.name AS 'cname',client.phone,rental.returnd FROM rental,client,book WHERE rental.bookID=book.ID AND rental.clientID=client.ID AND rental.valid='Y' ORDER BY client.ID";
